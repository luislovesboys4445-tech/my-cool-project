...
-- Spam function (rocket has delay, others zero)
...
-- =========================
-- Auto-Defense Based on StealBrainrot
-- =========================
local StealRemote = ReplicatedStorage:WaitForChild("Remotes"):WaitForChild("StealBrainrot")

StealRemote.OnClientEvent:Connect(function(thiefPlayer) -- Player stealing your brainrot
    if thiefPlayer and thiefPlayer.Parent == Players then
        runSpam(thiefPlayer)
    end
end)
